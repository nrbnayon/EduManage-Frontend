...
const StatsSection = () => {
  ...
  const header = {
    title: "---Our Platform Statistics---",
    desc: "Key metrics including total users, classes, and enrollments.",
  };
  ...
  return (
    <div>
      ...
      <div className="bg-gray-100 text-black py-16 flex flex-col md:flex-row justify-between items-center mb-6 rounded-md">
